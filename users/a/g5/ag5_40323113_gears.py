...
a40323113 = Blueprint('a40323113', __name__, url_prefix='/a40323113', template_folder='templates')
...
@a40323113.route('/eighteenthirty/<x>/<y>')
@a40323113.route('/eighteenthirty', defaults={'x':0, 'y':0})
def draweithteenthirdy(x,y):
    return head_str + chain_str + eighteenthirty(int(x), int(y)) + tail_str
 
 
@a40323113.route('/twocircle/<x>/<y>')
@a40323113.route('/twocircle', defaults={'x':0, 'y':0})
...
@a40323113.route('/gears', defaults={'n1':17,'n2':29,'n3':15})
@a40323113.route('/gears/<n1>/<n2>/<n3>')
def gears(n1, n2, n3):
    outstring = '''
<!DOCTYPE html>
<html>
